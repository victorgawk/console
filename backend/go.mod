...
require (
	...
	buf.build/gen/go/redpandadata/common/protocolbuffers/go v1.34.2-20240508150812-e0d0fbd58f25.2
	...
	github.com/victorgawk/java2json-go v0.0.4
	github.com/vmihailenco/msgpack/v5 v5.4.1
	github.com/zencoder/go-smile v0.0.0-20220221105746-06ef4fe5fa0a
	go.uber.org/mock v0.4.0
	go.uber.org/zap v1.27.0
	go.vallahaye.net/connect-gateway v0.5.1
